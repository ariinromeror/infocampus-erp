  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        ...
        {/* Deuda total */}
        <div className="bg-slate-900 p-5 sm:p-6 rounded-2xl shadow-sm text-white">
      ...
      {estudiante.es_becado && (
        <div className="bg-amber-50 border border-amber-200 p-4 sm:p-5 rounded-2xl flex items-center gap-3 sm:gap-4">
