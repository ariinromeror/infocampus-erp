  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        {/* Contador total */}
        <div className="bg-white border border-slate-200 px-4 sm:px-6 py-2 sm:py-3 rounded-2xl flex items-center gap-2 sm:gap-3">
      ...
      {/* BARRA DE BÚSQUEDA */}
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-3 sm:p-4 flex items-center gap-3 sm:gap-4">
      ...
      <div className="flex gap-2 sm:gap-3 flex-wrap">
        <button
          ...
          className={`px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-black transition-all text-xs sm:text-sm ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {materiasFiltradas.map((materia) => (
          <motion.div
            ...
            className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all relative overflow-hidden group"
          >
