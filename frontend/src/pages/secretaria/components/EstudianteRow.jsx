...
const EstudianteRow = ({ estudiante, isMobile = false }) => {
  ...
  if (isMobile) {
    return (
      <button
        onClick={handleClick}
        className="w-full bg-white border border-slate-100 rounded-2xl p-5 text-left hover:border-indigo-300 hover:shadow-md transition-all active:scale-[0.99]"
      >
